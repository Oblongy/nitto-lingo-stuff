...
on JOINRACECHAT
  ...
  ssm(((((((((((((((CRC & String.fromCharCode(30)) & param_unescape) & String.fromCharCode(30)) & param_ssm) & String.fromCharCode(30)) & CRC) & String.fromCharCode(30)) & param_String) & String.fromCharCode(30)) & fromCharCode) & String.fromCharCode(30)) & param_id_5) & String.fromCharCode(30)) & param_id_6)) -- 0x00B8
end
...
on LEAVERACECHAT
  ...
  ssm(((((((((JRC & String.fromCharCode(30)) & param_unescape) & String.fromCharCode(30)) & param_ssm) & String.fromCharCode(30)) & JRC) & String.fromCharCode(30)) & param_String)) -- 0x0074
end
...
on TEAMKICK
  ...
  ssm(((SRC & String.fromCharCode(30)) & unescape)) -- 0x003E
end
...
on LEAVEKOTH
  ...
  _global.objRace.raceType = KOTH -- 0x004C..0x004F
...
on STG
  ...
  Math = (Math.floor((param_Math * 1000)) / 1000) -- 0x0029
  ssm(((((KRT & String.fromCharCode(30)) & Math) & String.fromCharCode(30)) & param_floor)) -- 0x005B
end
...
on int
  ...
  ssm(((((((S & String.fromCharCode(30)) & Math) & String.fromCharCode(30)) & floor) & String.fromCharCode(30)) & ssm)) -- 0x009F
end
...
on KOK
  ...
  floor = (Math.floor((param_floor * 1000)) / 1000) -- 0x0042
  ssm = (Math.floor((param_ssm * 1000)) / 1000) -- 0x005B
  ssm(((((((((I & String.fromCharCode(30)) & Math) & String.fromCharCode(30)) & floor) & String.fromCharCode(30)) & ssm) & String.fromCharCode(30)) & param_I)) -- 0x00B1
end
...
on RIVDONE
  ...
  Math = (Math.floor((param_Math * 1000)) / 1000) -- 0x0029
  ssm(((((RIVRT & String.fromCharCode(30)) & Math) & String.fromCharCode(30)) & param_floor)) -- 0x005B
end
...
on HTJOIN
  ...
  ssm(((((((((((((((((((((((((((((((((((((((((((((RD & String.fromCharCode(30)) & Math) & String.fromCharCode(30)) & floor) & String.fromCharCode(30)) & param_trace) & String.fromCharCode(30)) & param_"before RD") & String.fromCharCode(30)) & param_decrypt) & String.fromCharCode(30)) & param__global) & String.fromCharCode(30)) & param_cwc) & String.fromCharCode(30)) & param_CheckWindows) & String.fromCharCode(30)) & param_cw) & String.fromCharCode(30)) & param_CheckWindowsClass) & String.fromCharCode(30)) & param_ssm) & String.fromCharCode(30)) & param_RD) & String.fromCharCode(30)) & param_String) & String.fromCharCode(30)) & param_fromCharCode) & String.fromCharCode(30)) & param_isCheatEngineRunning) & String.fromCharCode(30)) & param_CheckProcesses) & String.fromCharCode(30)) & param_cp) & String.fromCharCode(30)) & isCheatEngineRunning()) & String.fromCharCode(30)) & "after RD") & String.fromCharCode(30)) & CheckProcesses(decrypt(_global.cp))) & String.fromCharCode(30)) & CheckWindows(decrypt(_global.cw))) & String.fromCharCode(30)) & CheckWindowsClass(decrypt(_global.cwc)))) -- 0x0284
...
on HTREADY
  ...
  Math = (Math.floor((param_Math * 1000)) / 1000) -- 0x0029
  ssm(((((HQRT & String.fromCharCode(30)) & Math) & String.fromCharCode(30)) & param_floor)) -- 0x005B
end
...
on TRGETRACERS
  ...
  Math = (Math.floor((param_Math * 1000)) / 1000) -- 0x0029
  ssm(((((HTRT & String.fromCharCode(30)) & Math) & String.fromCharCode(30)) & param_floor)) -- 0x005B
end
...
on CheckNittoProcesses
  ...
  _player = 0 -- 0x0015
  if _player.applicationName.search(_global.exeName) = -1 then -- 0x002F
    _player = 1 -- 0x0034
  end if
  _player -- 0x003B
end
...
on CheckNittoProcessesCB
  ...
  if not (_player.debugPlaybackEnabled = TRUE) then -- 0x001B
    _global.checkedForOneClient = FALSE -- 0x0023..0x0026
    _global.checkProcessResult = getNetText((_global.mainURL & "oneclient.html?hey=1")) -- 0x003B..0x003E
  end if
end
...
on __embedded_lscr104_block75
  ...
  trace = FALSE -- 0x0024
  if param_trace = "0" then -- 0x002E
    "result: " = CheckProcesses(_global.exeName) -- 0x003F
    "0" = "result: ".split(",") -- 0x0050
    CheckProcesses = "0".length -- 0x005A
    if CheckProcesses > TRUE then -- 0x0062
      trace = TRUE -- 0x0067
    else
      if IsMyProcessNameCorrect() = 0 then -- 0x0076
        trace = 2 -- 0x007D
      end if
    end if
  end if
