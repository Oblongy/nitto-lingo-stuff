...
Scope:
- This pass documents embedded block `7888`.
- No opcode semantics are inferred by this pass.

Raw header evidence:
- JSON block offset `7888`, length `236`.
- File offset `9796`.
...
```text
3d 00 01 3a 00 01 35 00 02 39 3f 54 00 00 3a 00 02 51 00 00 03 00 00 00 00 00 00 00 04 00 00 00 06 00 00 00 73 00 70 00 72 00 69 00 74 00 65 00 01 00 00 00 04 00 00 00 07 00 00 00 66 00 6c 00
```
