...
Scope:
- This pass documents embedded block `7776`.
- No opcode semantics are inferred by this pass.

Raw header evidence:
- JSON block offset `7776`, length `280`.
- File offset `12384`.
...
Marker bytes:
```text
03 00 ad de 24 00 00 00 00 00 00 00 96 00 00 00
```

First instruction-region bytes:
```text
3d 00 01 3b 00 02 35 00 03 39 58 00 1e 3a 00 01 1b 3b 00 04 39 54 00 00 3a 00 01 1b 3a 00 01 51 05 00 00 00 00 00 00 00 04 00 00 00 03 00 00 00 73 00 73 00 6d 00 00 00 01 00 00 00 04 00 00 00
```

Recovered `kind = 4` UTF-16LE string records:
- payload offset `52`: id `0`, kind `4`, len `3`, `ssm`
- payload offset `72`: id `1`, kind `4`, len `2`, `TC`
- payload offset `88`: id `2`, kind `4`, len `6`, `String`
- payload offset `112`: id `3`, kind `4`, len `12`, `fromCharCode`
- payload offset `148`: id `4`, kind `4`, len `8`, `unescape`
