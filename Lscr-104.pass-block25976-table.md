...
Scope:
- This pass documents embedded block `25976`.
- No opcode semantics are inferred by this pass.

Raw header evidence:
- JSON block offset `25976`, length `220`.
- File offset `30584`.
...
```text
00 01 39 3a 00 00 51 00 02 00 00 00 00 00 00 00 04 00 00 00 07 00 00 00 5f 00 70 00 6c 00 61 00 79 00 65 00 72 00 00 00 01 00 00 00 04 00 00 00 04 00 00 00 71 00 75 00 69 00 74 00 06 00 00 00
```

Recovered `kind = 4` UTF-16LE string records:
- payload offset `28`: id `0`, kind `4`, len `7`, `_player`
- payload offset `56`: id `1`, kind `4`, len `4`, `quit`
