...
Scope:
- This pass documents embedded block `4060`.
- No opcode semantics are inferred by this pass.

Raw header evidence:
- JSON block offset `4060`, length `516`.
- File offset `8668`.
...
Marker bytes:
```text
03 00 ad de a5 00 00 00 00 00 00 00 96 00 00 00
```

First instruction-region bytes:
```text
54 00 02 3a 00 01 55 00 02 51 3b 00 00 39 54 00 04 3a 00 01 55 00 04 51 3b 00 01 39 3d 00 02 3b 00 03 35 00 04 39 58 00 1e 3a 00 01 1b 54 00 00 1b 3b 00 03 35 00 04 39 58 00 1e 3a 00 01 1b 54
```

Recovered `kind = 4` UTF-16LE string records:
- payload offset `184`: id `0`, kind `4`, len `8`, `unescape`
- payload offset `212`: id `1`, kind `4`, len `3`, `ssm`
- payload offset `232`: id `2`, kind `4`, len `3`, `CRC`
- payload offset `252`: id `3`, kind `4`, len `6`, `String`
- payload offset `276`: id `4`, kind `4`, len `12`, `fromCharCode`
