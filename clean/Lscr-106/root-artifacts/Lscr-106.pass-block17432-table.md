...
Scope:
- This pass documents embedded block `17432`.
- No opcode semantics are inferred by this pass.

Raw header evidence:
- JSON block offset `17432`, length `356`.
- File offset `19340`.
...
Marker bytes:
```text
03 00 ad de 4f 00 00 00 00 00 00 00 96 00 00 00
```

First instruction-region bytes:
```text
00 00 57 00 00 51 56 00 00 3e 17 07 00 3c 54 00 00 35 00 01 39 56 00 00 3a 00 01 3d 00 02 12 07 00 21 54 00 00 35 00 03 39 56 00 00 3f 1b 54 00 00 35 00 00 56 00 00 1c 58 00 05 1c 3a 00 02 05
```

Recovered `kind = 4` UTF-16LE string records:
- payload offset `96`: id `0`, kind `4`, len `6`, `length`
- payload offset `120`: id `1`, kind `4`, len `6`, `charAt`
- payload offset `144`: id `2`, kind `4`, len `1`, `\`
- payload offset `160`: id `3`, kind `4`, len `6`, `substr`
