...
Scope:
- This pass documents embedded block `11724`.
- No opcode semantics are inferred by this pass.

Raw header evidence:
- JSON block offset `11724`, length `384`.
- File offset `13632`.
...
```text
3b 00 01 3d 00 02 1b 54 00 00 3a 00 02 51 3b 00 03 39 3a 00 00 51 00 00 04 00 00 00 00 00 00 00 04 00 00 00 12 00 00 00 63 00 72 00 65 00 61 00 74 00 65 00 43 00 61 00 63 00 68 00 65 00 46 00
```

Recovered `kind = 4` UTF-16LE string records:
- payload offset `44`: id `0`, kind `4`, len `18`, `createCacheFolders`
- payload offset `92`: id `1`, kind `4`, len `11`, `cacheFolder`
- payload offset `128`: id `2`, kind `4`, len `1`, `\`
- payload offset `144`: id `3`, kind `4`, len `17`, `downloadCacheDone`
