...
on RaceEngine_parseConfig
  ...
  parseString(param_xtra) -- 0x002F
  -- 0x3F property-chain marker -- 0x003A
  xmlparser = n2 -- 0x003F
  xtra[makeList()] -- 0x0042
  xtra = VOID -- 0x0044
  xtra -- 0x0047
  w = "!ATTRIBUTES"(r) -- 0x0059
  xmlparser -- 0x005C
  hpi = "!ATTRIBUTES"(v) -- 0x006E
  xmlparser -- 0x0071
  stockRedLine = "!ATTRIBUTES"(a) -- 0x0083
  xmlparser -- 0x0086
  redLine = "!ATTRIBUTES"(n) -- 0x0098
  xmlparser -- 0x009B
  revLimiter = "!ATTRIBUTES"(o) -- 0x00AD
  xmlparser -- 0x00B0
  r = "!ATTRIBUTES"(s) -- 0x00C2
  xmlparser -- 0x00C5
  detuneHp = "!ATTRIBUTES"(b) -- 0x00D7
  xmlparser -- 0x00DA
  UsInit = "!ATTRIBUTES"(p) -- 0x00EC
  xmlparser -- 0x00EF
  UkInit = (c0_7 * UsInit) -- 0x00FA
  parseFloat -- 0x00FD
  stockBoost = "!ATTRIBUTES"(c) -- 0x010F
  xmlparser -- 0x0112
  boostSetting = "!ATTRIBUTES"(e) -- 0x0124
  xmlparser -- 0x0127
  boostType = d -- 0x0132
  "!ATTRIBUTES" -- 0x0135
  initBoost() -- 0x013E
  ...
  xmlparser -- 0x01CF
  NOS = "!ATTRIBUTES"(q) -- 0x01E1
  xmlparser -- 0x01E4
  nitrousRemaining = "!ATTRIBUTES"(m) -- 0x01F6
  xmlparser -- 0x01F9
  nitrousTankSize = "!ATTRIBUTES"(t) -- 0x020B
  xmlparser -- 0x020E
  ...
  parseInt -- 0x0243
  maxPsi = "!ATTRIBUTES"(u) -- 0x0255
  xmlparser -- 0x0258
  airhpi = "!ATTRIBUTES"(w) -- 0x026A
  xmlparser -- 0x026D
  turboFlow = "!ATTRIBUTES"(x) -- 0x027F
  xmlparser -- 0x0282
  fuelFlowLimit = "!ATTRIBUTES"(y) -- 0x0294
  xmlparser -- 0x0297
  overallAirFlowLimit = "!ATTRIBUTES"(z) -- 0x02A9
  xmlparser -- 0x02AC
  cylinderNumber = "!ATTRIBUTES"(aa) -- 0x02BE
  xmlparser -- 0x02C1
  valveNumber = "!ATTRIBUTES"(ab) -- 0x02D3
  xmlparser -- 0x02D6
  pistonCompressionLevel = "!ATTRIBUTES"(ac) -- 0x02E8
  xmlparser -- 0x02EB
  chipSetting = "!ATTRIBUTES"(ad) -- 0x02FD
  xmlparser -- 0x0300
  pistonDurability = "!ATTRIBUTES"(ae) -- 0x0312
  xmlparser -- 0x0315
  rodDurability = "!ATTRIBUTES"(af) -- 0x0327
  xmlparser -- 0x032A
  valveDurability = "!ATTRIBUTES"(ag) -- 0x033C
  xmlparser -- 0x033F
  headGasketDurability = "!ATTRIBUTES"(ah) -- 0x0351
  xmlparser -- 0x0354
  engineBlockDurability = "!ATTRIBUTES"(ai) -- 0x0366
  xmlparser -- 0x0369
  oilDurability = "!ATTRIBUTES"(ao) -- 0x037B
  xmlparser -- 0x037E
  radiatorDurability = "!ATTRIBUTES"(at) -- 0x0390
  xmlparser -- 0x0393
  oilFilterDurability = "!ATTRIBUTES"(au) -- 0x03A5
  xmlparser -- 0x03A8
  coolantDurability = "!ATTRIBUTES"(aw) -- 0x03BA
  xmlparser -- 0x03BD
  pistonDamage = ((("!ATTRIBUTES"(aj) / c100) * partBreakPoint) * cylinderNumber) -- 0x03DE
  xmlparser -- 0x03E1
  rodDamage = ((("!ATTRIBUTES"(ak) / c100) * partBreakPoint) * cylinderNumber) -- 0x0402
  xmlparser -- 0x0405
  valveDamage = ((("!ATTRIBUTES"(al) / c100) * partBreakPoint) * valveNumber) -- 0x0426
  xmlparser -- 0x0429
  headGasketDamage = (("!ATTRIBUTES"(am) / c100) * partBreakPoint) -- 0x0445
  xmlparser -- 0x0448
  engineBlockDamage = (("!ATTRIBUTES"(an) / c100) * partBreakPoint) -- 0x0464
  xmlparser -- 0x0467
  oilDamage = "!ATTRIBUTES"(ap) -- 0x0479
  xmlparser -- 0x047C
  oilFilterDamage = "!ATTRIBUTES"(av) -- 0x048E
  xmlparser -- 0x0491
  coolantDamage = "!ATTRIBUTES"(ax) -- 0x04A3
  xmlparser -- 0x04A6
  raceGas = "!ATTRIBUTES"(aq) -- 0x04B8
  xmlparser -- 0x04BB
  tireStick = "!ATTRIBUTES"(ar) -- 0x04CD
  xmlparser -- 0x04D0
  launchControl = "!ATTRIBUTES"(as) -- 0x04E2
  xmlparser -- 0x04E5
...
on RaceEngine_runFrame
  ...
  -- jump 101 -- 0x0C24
  -- branch evidence (control-flow-evidence)
  if not (raceType = RIVAL) then -- jump 11 marker 0x44 -- 0x0C2E
  -- branch evidence (control-flow-evidence)
  if not (raceType = TEAMRIVAL) then -- jump 22 -- 0x0C39
  ...
  -- jump 101 -- 0x0CF8
  -- branch evidence (control-flow-evidence)
  if not (raceType = RIVAL) then -- jump 11 marker 0x44 -- 0x0D02
  -- branch evidence (control-flow-evidence)
  if not (raceType = TEAMRIVAL) then -- jump 22 -- 0x0D0D
  ...
  -- jump 143 -- 0x0DE6
  -- branch evidence (control-flow-evidence)
  if not (raceType = RIVAL) then -- jump 11 marker 0x44 -- 0x0DF0
  -- branch evidence (control-flow-evidence)
  if not (raceType = TEAMRIVAL) then -- jump 36 -- 0x0DFB
...
on RaceEngine_createMd5Hash
  ...
  case raceType of
    ...
    TEAMRIVAL:
      -- 0x0B boolean-chain marker left=(raceType = RIVAL) -- 0x00B9
      RIVREADY(VOID, createMd5Hash(0)) -- 0x00D6
    P:
      -- 0x0B boolean-chain marker left=(raceType = CTQ) -- 0x00E4
