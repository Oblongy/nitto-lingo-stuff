...
class Lscr102RaceEngine {
  ...
  RaceEngine_runFrame(frameInput = 0) {
    ...
    // RPM accumulation (Block 08)
    if ((this.theActualTime - this.c299) < this.theActualTime) {
      const rpmDelta = this._system().milliseconds - this.c1000;
      if (rpmDelta > 0) {
...
module.exports = { Lscr102RaceEngine, VOID, EMPTY };
