...
Scope:
- This pass documents embedded block `24448`.
- No opcode semantics are inferred by this pass.

Raw header evidence:
- JSON block offset `24448`, length `280`.
- File offset `29056`.
...
```text
3d 00 01 3b 00 02 35 00 03 39 58 00 1e 3a 00 01 1b 54 00 00 1b 3a 00 01 51 00 00 00 04 00 00 00 00 00 00 00 04 00 00 00 03 00 00 00 73 00 73 00 6d 00 00 00 01 00 00 00 04 00 00 00 03 00 00 00
```

Recovered `kind = 4` UTF-16LE string records:
- payload offset `48`: id `0`, kind `4`, len `3`, `ssm`
- payload offset `68`: id `1`, kind `4`, len `3`, `TRO`
