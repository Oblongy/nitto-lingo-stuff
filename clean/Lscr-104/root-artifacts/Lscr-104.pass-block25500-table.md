...
Scope:
- This pass documents embedded block `25500`.
- No opcode semantics are inferred by this pass.

Raw header evidence:
- JSON block offset `25500`, length `476`.
- File offset `30108`.
...
Marker bytes:
```text
03 00 ad de d1 00 00 00 00 00 00 00 96 00 00 00
```
...
- payload offset `228`: id `0`, kind `4`, len `3`, `ssm`
- payload offset `248`: id `1`, kind `4`, len `1`, `M`
- payload offset `264`: id `2`, kind `4`, len `6`, `String`
- payload offset `288`: id `3`, kind `4`, len `12`, `fromCharCode`
