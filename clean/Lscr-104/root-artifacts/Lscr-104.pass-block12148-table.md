...
Scope:
- This pass documents embedded block `12148`.
- No opcode semantics are inferred by this pass.

Raw header evidence:
- JSON block offset `12148`, length `456`.
- File offset `16756`.
...
Marker bytes:
```text
03 00 ad de 9e 00 00 00 00 00 00 00 96 00 00 00
```

First instruction-region bytes:
```text
00 01 39 54 00 00 58 03 e8 1d 3a 00 01 58 03 e8 1e 55 00 00 51 3b 00 00 35 00 01 39 54 00 01 58 03 e8 1d 3a 00 01 58 03 e8 1e 55 00 01 51 3b 00 00 35 00 01 39 54 00 02 58 03 e8 1d 3a 00 01 58
```

Recovered `kind = 4` UTF-16LE string records:
- payload offset `176`: id `0`, kind `4`, len `4`, `Math`
- payload offset `196`: id `1`, kind `4`, len `5`, `floor`
- payload offset `220`: id `2`, kind `4`, len `3`, `ssm`
- payload offset `240`: id `3`, kind `4`, len `1`, `I`
- payload offset `256`: id `4`, kind `4`, len `6`, `String`
- payload offset `280`: id `5`, kind `4`, len `12`, `fromCharCode`
