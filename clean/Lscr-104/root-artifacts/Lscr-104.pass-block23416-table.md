...
Scope:
- This pass documents embedded block `23416`.
- No opcode semantics are inferred by this pass.

Raw header evidence:
- JSON block offset `23416`, length `448`.
- File offset `28024`.
...
- payload offset `172`: id `0`, kind `4`, len `3`, `ssm`
- payload offset `192`: id `1`, kind `4`, len `4`, `TRRQ`
- payload offset `212`: id `2`, kind `4`, len `6`, `String`
- payload offset `236`: id `3`, kind `4`, len `12`, `fromCharCode`
