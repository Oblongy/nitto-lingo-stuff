...
Scope:
- This pass documents embedded block `12604`.
- No opcode semantics are inferred by this pass.

Raw header evidence:
- JSON block offset `12604`, length `392`.
- File offset `17212`.
...
Marker bytes:
```text
03 00 ad de 2e 00 00 00 00 00 00 00 96 00 00 00
```

First instruction-region bytes:
```text
3d 00 01 3b 00 02 35 00 03 39 58 00 1e 3a 00 01 1b 54 00 00 1b 3a 00 01 51 3b 00 04 35 00 05 35 00 06 39 3d 00 07 3a 00 01 51 00 00 08 00 00 00 00 00 00 00 04 00 00 00 03 00 00 00 73 00 73 00
```

Recovered `kind = 4` UTF-16LE string records:
- payload offset `64`: id `0`, kind `4`, len `3`, `ssm`
- payload offset `84`: id `1`, kind `4`, len `3`, `KOK`
- payload offset `104`: id `2`, kind `4`, len `6`, `String`
- payload offset `128`: id `3`, kind `4`, len `12`, `fromCharCode`
- payload offset `164`: id `4`, kind `4`, len `7`, `_global`
- payload offset `192`: id `5`, kind `4`, len `7`, `objRace`
- payload offset `220`: id `6`, kind `4`, len `4`, `init`
- payload offset `240`: id `7`, kind `4`, len `4`, `KOTH`
