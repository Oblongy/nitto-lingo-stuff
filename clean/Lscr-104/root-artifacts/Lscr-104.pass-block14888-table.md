...
Scope:
- This pass documents embedded block `14888`.
- No opcode semantics are inferred by this pass.

Raw header evidence:
- JSON block offset `14888`, length `632`.
- File offset `19496`.
...
- payload offset `152`: id `3`, kind `4`, len `5`, `RIVRT`
- payload offset `176`: id `4`, kind `4`, len `6`, `String`
- payload offset `200`: id `5`, kind `4`, len `12`, `fromCharCode`
