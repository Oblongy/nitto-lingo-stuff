...
Scope:
- This pass documents embedded block `17932`.
- No opcode semantics are inferred by this pass.

Raw header evidence:
- JSON block offset `17932`, length `156`.
- File offset `22540`.
...
```text
3d 00 01 3a 00 01 51 00 02 00 00 00 00 00 00 00 04 00 00 00 03 00 00 00 73 00 73 00 6d 00 00 00 01 00 00 00 04 00 00 00 06 00 00 00 48 00 54 00 51 00 55 00 49 00 54 00 04 00 00 00 b0 67 07 00
```

Recovered `kind = 4` UTF-16LE string records:
- payload offset `28`: id `0`, kind `4`, len `3`, `ssm`
- payload offset `48`: id `1`, kind `4`, len `6`, `HTQUIT`
