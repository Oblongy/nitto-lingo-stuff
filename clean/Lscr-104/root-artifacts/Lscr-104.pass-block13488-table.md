...
Scope:
- This pass documents embedded block `13488`.
- No opcode semantics are inferred by this pass.

Raw header evidence:
- JSON block offset `13488`, length `376`.
- File offset `18096`.
...
Marker bytes:
```text
03 00 ad de 65 00 00 00 00 00 00 00 96 00 00 00
```

First instruction-region bytes:
```text
3d 00 01 3b 00 02 35 00 03 39 58 00 1e 3a 00 01 1b 54 00 00 1b 3b 00 02 35 00 03 39 58 00 1e 3a 00 01 1b 54 00 01 1b 3b 00 02 35 00 03 39 58 00 1e 3a 00 01 1b 54 00 02 1b 3b 00 02 35 00 03 39
```

Recovered `kind = 4` UTF-16LE string records:
- payload offset `120`: id `0`, kind `4`, len `3`, `ssm`
- payload offset `140`: id `1`, kind `4`, len `3`, `RRQ`
- payload offset `160`: id `2`, kind `4`, len `6`, `String`
- payload offset `184`: id `3`, kind `4`, len `12`, `fromCharCode`
