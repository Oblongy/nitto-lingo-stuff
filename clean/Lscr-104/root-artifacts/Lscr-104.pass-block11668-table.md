...
Scope:
- This pass documents embedded block `11668`.
- No opcode semantics are inferred by this pass.

Raw header evidence:
- JSON block offset `11668`, length `480`.
- File offset `16276`.
...
Marker bytes:
```text
03 00 ad de 8c 00 00 00 00 00 00 00 96 00 00 00
```
...
- payload offset `156`: id `0`, kind `4`, len `4`, `Math`
- payload offset `176`: id `1`, kind `4`, len `5`, `floor`
- payload offset `200`: id `2`, kind `4`, len `3`, `ssm`
- payload offset `220`: id `3`, kind `4`, len `1`, `S`
- payload offset `236`: id `4`, kind `4`, len `6`, `String`
- payload offset `260`: id `5`, kind `4`, len `12`, `fromCharCode`
