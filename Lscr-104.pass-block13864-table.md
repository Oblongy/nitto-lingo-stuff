...
Scope:
- This pass documents embedded block `13864`.
- No opcode semantics are inferred by this pass.

Raw header evidence:
- JSON block offset `13864`, length `280`.
- File offset `18472`.
...
Marker bytes:
```text
03 00 ad de 41 00 00 00 00 00 00 00 96 00 00 00
```

First instruction-region bytes:
```text
3d 00 01 3b 00 02 35 00 03 39 58 00 1e 3a 00 01 1b 54 00 00 1b 3b 00 02 35 00 03 39 58 00 1e 3a 00 01 1b 54 00 01 1b 3b 00 02 35 00 03 39 58 00 1e 3a 00 01 1b 54 00 02 1b 3a 00 01 51 00 00 00
```

Recovered `kind = 4` UTF-16LE string records:
- payload offset `84`: id `0`, kind `4`, len `3`, `ssm`
- payload offset `104`: id `1`, kind `4`, len `3`, `RRS`
- payload offset `124`: id `2`, kind `4`, len `6`, `String`
- payload offset `148`: id `3`, kind `4`, len `12`, `fromCharCode`
