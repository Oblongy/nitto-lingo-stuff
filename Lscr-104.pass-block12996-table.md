...
Scope:
- This pass documents embedded block `12996`.
- No opcode semantics are inferred by this pass.

Raw header evidence:
- JSON block offset `12996`, length `264`.
- File offset `17604`.
...
- payload offset `84`: id `1`, kind `4`, len `2`, `KR`
- payload offset `100`: id `2`, kind `4`, len `6`, `String`
- payload offset `124`: id `3`, kind `4`, len `12`, `fromCharCode`
