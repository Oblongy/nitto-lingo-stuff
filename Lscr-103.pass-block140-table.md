...
Scope:
- This pass documents embedded block `140`.
- No opcode semantics are inferred by this pass.

Raw header evidence:
- JSON block offset `140`, length `224`.
- File offset `848`.
...
```text
00 01 35 00 02 39 3a 00 00 51 00 00 03 00 00 00 00 00 00 00 04 00 00 00 07 00 00 00 5f 00 67 00 6c 00 6f 00 62 00 61 00 6c 00 00 00 01 00 00 00 04 00 00 00 07 00 00 00 6f 00 62 00 6a 00 52 00
```

Recovered `kind = 4` UTF-16LE string records:
- payload offset `32`: id `0`, kind `4`, len `7`, `_global`
- payload offset `60`: id `1`, kind `4`, len `7`, `objRace`
- payload offset `88`: id `2`, kind `4`, len `9`, `beginRace`
