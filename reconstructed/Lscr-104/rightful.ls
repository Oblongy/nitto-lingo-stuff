...
on SENDNIMMESSAGE
  ...
  (String & fromCharCode(30))((_global & guid)) -- 0x0033
end
...
on UPDATENIMUSER
  ...
  ((String & fromCharCode(30)) & param_ssm)(((String & fromCharCode(30)) & unescape(param_SN))) -- 0x0049
end
...
on DELETENIMUSER
  ...
  UNU(((String & fromCharCode(30)) & param_ssm)) -- 0x0030
end
...
on BLOCKNIMUSER
  ...
  DU(((String & fromCharCode(30)) & param_ssm)) -- 0x0030
end
...
on UNBLOCKNIMUSER
  ...
  BU(((String & fromCharCode(30)) & param_ssm)) -- 0x0030
end
...
on INQUIRYNIMUSER
  ...
  UU(((String & fromCharCode(30)) & param_ssm)) -- 0x0030
end
...
on ALLOWNIMUSER
  ...
  IU(((String & fromCharCode(30)) & unescape(param_ssm))) -- 0x0037
end
...
on NIMOKRESPONSE
  ...
  ((String & fromCharCode(30)) & param_ssm)(((String & fromCharCode(30)) & param_AU)) -- 0x0042
end
...
on DELETENIMINQUIREDUSER
  ...
  OR(((String & fromCharCode(30)) & param_ssm)) -- 0x0030
end
...
on GETNIMINREQUESTS
  ...
  DIU(((String & fromCharCode(30)) & param_ssm)) -- 0x0030
end
...
on CREATECHATROOM
  ...
  ((String & fromCharCode(30)) & param_ssm)(((String & fromCharCode(30)) & param_LRCR2)) -- 0x0042
end
...
on JOINRACECHAT
  ...
  ((String & fromCharCode(30)) & param_id_5)(((String & fromCharCode(30)) & param_id_6)) -- 0x00B8
end
...
on LEAVERACECHAT
  ...
  ((String & fromCharCode(30)) & param_JRC)(((String & fromCharCode(30)) & param_String)) -- 0x0074
end
...
on TEAMKICK
  ...
  SRC(((String & fromCharCode(30)) & param_unescape)) -- 0x003E
end
...
on TEAMCHANGEROLE
  ...
  TK(((String & fromCharCode(30)) & param_ssm)) -- 0x0030
end
...
on TEAMUPDATEMAXBET
  ...
  ((String & fromCharCode(30)) & param_TCR)(((String & fromCharCode(30)) & param_String)) -- 0x0054
end
...
on TEAMDEPOSIT
  ...
  ((String & fromCharCode(30)) & param_ssm)(((String & fromCharCode(30)) & param_TUB)) -- 0x0042
end
...
on TEAMWITHDRAW
  ...
  TDP(((String & fromCharCode(30)) & param_ssm)) -- 0x0030
end
...
on TEAMQUIT
  ...
  TW(((String & fromCharCode(30)) & param_ssm)) -- 0x0030
end
...
on TEAMDISPERSE
  ...
  TAT(((String & fromCharCode(30)) & param_ssm)) -- 0x0030
end
...
on TEAMCREATE
  ...
  ((String & fromCharCode(30)) & param_ssm)(((String & fromCharCode(30)) & param_TDB)) -- 0x0042
end
...
on TEAMSTEPDOWN
  ...
  TC(((String & fromCharCode(30)) & unescape(param_ssm))) -- 0x0037
end
...
on LEAVEKOTH
  ...
  ((String & fromCharCode(30)) & param_ssm)(((String & fromCharCode(30)) & param_JK)) -- 0x0042
...
on SENDVOTE
  ...
  ((String & fromCharCode(30)) & param_ssm)(((String & fromCharCode(30)) & param_KC)) -- 0x0042
  init(KOTH) -- 0x0053
end
...
on KDONE
  ...
  ((String & fromCharCode(30)) & param_ssm)(((String & fromCharCode(30)) & param_SV)) -- 0x0042
end
...
on KRT
  ...
  Math = (floor((param_Math * 1000)) / 1000) -- 0x0029
  Math -- 0x002C
  floor = (floor((param_floor * 100)) / 100) -- 0x0042
  Math -- 0x0045
  id_17 = (floor((param_id_17 * 1000)) / 1000) -- 0x005B
  Math -- 0x005E
  (String & fromCharCode(30))((CheckWindowsClass & decrypt(_global(cwc)))) -- 0x022C
end
...
on STG
  ...
  Math = (floor((param_Math * 1000)) / 1000) -- 0x0029
  Math -- 0x002C
  ((String & fromCharCode(30)) & param_Math)(((String & fromCharCode(30)) & param_floor)) -- 0x005B
end
...
on int
  ...
  Math = (floor((param_Math * 1000)) / 1000) -- 0x0029
  Math -- 0x002C
  floor = (floor((param_floor * 1000)) / 1000) -- 0x0042
  Math -- 0x0045
  ssm = (floor((param_ssm * 1000)) / 1000) -- 0x005B
  Math -- 0x005E
  ((String & fromCharCode(30)) & param_floor)(((String & fromCharCode(30)) & param_ssm)) -- 0x009F
end
...
on KOK
  ...
  ssm = (floor((param_ssm * 1000)) / 1000) -- 0x005B
  Math -- 0x005E
  ((String & fromCharCode(30)) & param_ssm)(((String & fromCharCode(30)) & param_I)) -- 0x00B1
end
...
on KREADY
  ...
  KOK(((String & fromCharCode(30)) & param_ssm)) -- 0x0030
  init(KOTH) -- 0x0041
end
...
on GETRIVALS
  ...
  ((String & fromCharCode(30)) & param_ssm)(((String & fromCharCode(30)) & param_KR)) -- 0x0042
end
...
on RRSP
  ...
  ((String & fromCharCode(30)) & param_fromCharCode)(((String & fromCharCode(30)) & param_id_4)) -- 0x0078
end
...
on RLVE
  ...
  ((String & fromCharCode(30)) & param_RRS)(((String & fromCharCode(30)) & param_String)) -- 0x0054
end
...
on RIVRT
  ...
  ((String & fromCharCode(30)) & param_ssm)(((String & fromCharCode(30)) & param_RR)) -- 0x0042
end
...
on HTJOIN
  ...
  floor = (floor((param_floor * 100)) / 100) -- 0x0042
  Math -- 0x0045
  "after RD" = (floor((param_"after RD" * 1000)) / 1000) -- 0x005B
  Math -- 0x005E
  trace("before RD") -- 0x0069
  decrypt(_global(cwc)) -- 0x007E
  CheckWindows(decrypt(_global(cw))) -- 0x009A
  CheckWindowsClass(decrypt(_global(cwc))) -- 0x00B6
  (String & fromCharCode(30))((CheckWindowsClass & decrypt(_global(cwc)))) -- 0x0284
...
on HQOK
  ...
  JT(((String & fromCharCode(30)) & param_ssm)) -- 0x0030
end
...
on HTGET32
  ...
  HQOK(((String & fromCharCode(30)) & param_ssm)) -- 0x0030
end
...
on HTQD
  ...
  ((String & fromCharCode(30)) & param_ssm)(((String & fromCharCode(30)) & param_HQR)) -- 0x0042
end
...
on HTD
  ...
  ((String & fromCharCode(30)) & param_ssm)(((String & fromCharCode(30)) & param_HTR)) -- 0x0042
end
...
on TRREQUEST
  ...
  TRPRQ(((String & fromCharCode(30)) & param_ssm)) -- 0x0030
end
...
on TRCOUNTER
  ...
  ((String & fromCharCode(30)) & param_id_6)(((String & fromCharCode(30)) & param_id_7)) -- 0x00AE
end
...
on TRRESPONSE
  ...
  ((String & fromCharCode(30)) & param_ssm)(((String & fromCharCode(30)) & param_TRCT)) -- 0x0042
end
...
on TROK
  ...
  ((String & fromCharCode(30)) & param_ssm)(((String & fromCharCode(30)) & param_TRRS)) -- 0x0042
end
...
on TRIVREADY
  ...
  TRO(((String & fromCharCode(30)) & param_ssm)) -- 0x0030
end
...
on JOINELECTION
  ...
  ((String & fromCharCode(30)) & param_ssm)(((String & fromCharCode(30)) & param_TRR)) -- 0x0042
end
...
on CLOSEGAME
  ...
  ((String & fromCharCode(30)) & param_id_9)(((String & fromCharCode(30)) & param_id_10)) -- 0x00E4
end
...
on CheckNittoProcesses
  ...
  _player = 0 -- 0x0015
  if not (_global(exeName) <> -1) then -- jump 8 -- 0x002F
  _player = 1 -- 0x0034
  search -- 0x0037
  _player -- 0x003B
end
...
on CheckNittoProcessesCB
  ...
  if not (implicit_lhs_0x001B = _player[debugPlaybackEnabled]) then -- jump 3 -- 0x001B
  checkedForOneClient = VOID -- 0x0023
  _global -- 0x0026
  checkProcessResult = _global((mainURL & "oneclient.html?hey=1")) -- 0x003B
  getNetText -- 0x003E
end
...
on __embedded_lscr104_block75
  ...
  "result: " = _global(exeName) -- 0x003F
  CheckProcesses -- 0x0042
  "0" = split(",") -- 0x0050
  "result: " -- 0x0053
  CheckProcesses = length -- 0x005A
  "0" -- 0x005D
  if not (implicit_lhs_0x0062 > implicit_object_0x0061[CheckProcesses]) then -- jump 11 -- 0x0062
  trace = implicit_object_0x0066[implicit_index_0x0066] -- 0x0067
  -- jump 22 -- 0x006B
  if not (IsMyProcessNameCorrect() = 0) then -- jump 10 -- 0x0076
  trace = "0" -- 0x007D
  trace(("flashReturnValue: " & trace)) -- 0x008F
  CheckNittoProcessesCB(trace) -- 0x00A4
end
