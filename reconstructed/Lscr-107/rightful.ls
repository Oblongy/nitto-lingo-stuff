...
on startMovie
  ...
  _global -- 0x006F
  gameURL = (mainURL & "gameCode1_00.aspx") -- 0x007D
  _global -- 0x0080
  avatarMainURL = mainURL -- 0x008A
  _global -- 0x008D
...
on setInactive
  ...
  2.2528 -- 0x003D
  2.2528 -- 0x0069
  rect = _movie(stage, rect, bottom, (_movie((stage / (rect - top))) * round)) -- 0x0075
  round -- 0x0078
  rect = rect -- 0x0086
